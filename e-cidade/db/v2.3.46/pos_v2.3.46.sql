insert into db_versao (db30_codver, db30_codversao, db30_codrelease, db30_data, db30_obs)  values (362, 3, 46, '2016-01-13', 'Tarefas: 99332');insert into db_versaoant (db31_codver,db31_data) values (362, current_date);
...
select setval ('db_versaocpdarq_db34_codarq_seq',(select max (db34_codarq) from db_versaocpdarq));create table bkp_db_permissao_20160113_095827 as select * from db_permissao;
