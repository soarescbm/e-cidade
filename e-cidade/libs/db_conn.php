...
$DB_SENHA     = "admin#1920"; // Senha do usuário do PostgreSQL
...
$DB_PORTA_ALT = "5432"; // Porta para conexao direta com PostgreSQL quando tivermos um pool de conexao
$DB_BASE      = "ecidade_demo"; // Nome da base de dados
$DB_SELLER    = "";
